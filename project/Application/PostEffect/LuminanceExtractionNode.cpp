...
void LuminanceExtractionNode::set_texture_resource(D3D12_GPU_DESCRIPTOR_HANDLE textureGPUHandle_) {
...
void LuminanceExtractionNode::create_pipeline_state() {
	...
	shaderManager.initialize(
		...
		"GameResources/HLSL/LuminanceExtraction.PS.hlsl"
	);
...
#include <imgui.h>
void LuminanceExtractionNode::debug_gui() {
	ImGui::DragFloat("Intensity", &luminanceExtractionInfo.get_data()->intensity, 0.001f);

	luminanceExtractionInfo.get_data()->color.debug_gui("Color");
}
#endif // DEBUG_FEATURES_ENABLE
